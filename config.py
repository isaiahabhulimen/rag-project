...
llm_name = os.getenv("LLM_NAME", "openai/gpt-oss-120b")
...
storage_access_key = os.getenv("ACCESS_KEY_ID")

storage_secret_key = os.getenv("SECRET_ACCESS_KEY")

storage_region = os.getenv("REGION")
...
worker_api_url = os.getenv("WORKER_API_URL", "http://rag-project.railway.internal:8000")
...
collection_name = os.getenv("COLLECTION_NAME", "richest_man_babylon")
